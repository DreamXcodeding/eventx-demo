...
export default function AdminOrganizers() {
  ...
  const approve = useAdminStore((s) => s.approveOrganizer);
  const reject = useAdminStore((s) => s.rejectOrganizer);
              ...
              <div className="flex flex-wrap items-start justify-between gap-3">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`rounded-full px-2.5 py-0.5 text-[11px] font-medium ${STATUS_CLS[o.status]}`}>{t(STATUS_KEY[o.status])}</span>
                  </div>
                ...
                <div className="text-right">
                  {o.status === "APPROVED" && o.feeBps != null && (
